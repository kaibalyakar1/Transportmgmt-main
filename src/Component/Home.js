...
class Home extends Component {
    ...
    render() {
        const bg = "src/components/img/truck-home-2.jpg";
                            ...
                            <div className="container-fluid">
                                ...
                                <div className="collapse navbar-collapse" id="navbarCollapse">
                                    ...
                                    <form className="d-flex">
                                        <button className="btn btn-warning font-weight-bold" onClick={this.signInHandler} type="submit">
                                            <i className="fa fa-user-circle fa-lg " aria-hidden="true" /> Login
                                        </button>
                                    </form>
                                </div>
                            </div>
                    ...
                    <main>
                        <div id="myCarousel" className="carousel slide" data-ride="carousel">
                            ...
                            <div className="carousel-inner">
                                <div className="carousel-item active">
                                    ...
                                    <img src={bgimg} className="img-fluid img-responsive" alt="Background" />

                                    <div className="container">
                                        <div className="carousel-caption">
                                            <h1>CentroShipping</h1>
                                            <h3>Start Your Business Now!!</h3>
                                            <p>
                                                <a className="btn btn-lg btn-info" onClick={this.signUpHandler} role="button">
                                                    Sign Up Now &nbsp;<i className="fa fa-truck fa-flip-horizontal fa-lg" />
                                                </a>
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <div className="container marketing">
                            <div className="row featurette text-secondary" id="aboutus">
                                ...
                                <h4>We connect people, We help business to grow, we provide transportation Services. We provide an instant affordable Auto Transport
                                    On this platform, you can join as a Service provider to grow your business
                                </h4>
                                <h4> We do not only provide customized storage solutions that align with your business but also provide
                                    a range of other warehousing services, which includes fulfillment, logistic support, distribution, door-to-door transport, pick and pack operations, and so on.
                                </h4>
                                <h4>Apart from the regular warehousing services, we provide a range of value-added customer-specific services to help them
                                    with their business, order fulfillment, packaging, assembly, and kitting requirements
                                </h4>
                            </div>
                            ...
                            <div className="row featurette">
                                ...
                                <div className="col-md-5">
                                    <img className="img-thumbnail" src="https://source.unsplash.com/500x500/?logistics" alt="Logistics" />
                                </div>
                            </div>
                            <hr className="featurette-divider" />
                            <div className="row featurette">
                                <div className="col-md-7 order-md-2">
                                    <h2 className="featurette-heading">Transport Service At Your Door <span className="text-muted">Join Us As a
                                        Customer</span></h2>
                                    <p className="lead">Here, you can reach out to various transport service providers, Your goods our
                                        responsibility!!</p>
                                </div>
                        ...
                        <footer className="container-fluid text-center" id="contact">
                            <div className="row">
                                ...
                                <div className="col-sm-3">
                                    <h3>Address</h3>
                                    <h5><i className="fa fa-map-marker" aria-hidden="true" />&nbsp;Main building, centurion university, 752050
                                    </h5>
                                </div>
                                <div className="col-sm-3">
                                    <h3>Reach To Us</h3>
                                    <h5><i className="fa fa-envelope" aria-hidden="true" /> vicky@gmail.com</h5>
